...
if __name__ == "__main__":
    ...
    if Cuda:
        ...
        net = net.cuda()
    # 打开训练数据集的txt
    with open(r"图像分割/FCN/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt","r") as f:
        train_lines = f.readlines()
    # 打开验证集数据集的txt
    with open(r"图像分割/FCN/VOCdevkit/VOC2012/ImageSets/Segmentation/val.txt","r") as f:
