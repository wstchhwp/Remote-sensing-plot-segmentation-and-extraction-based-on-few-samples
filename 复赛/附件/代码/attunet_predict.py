...
class AttUNet(object):
    ...
    #--------------------------------------------------------------#
    _defaults = {
        "model_path"        :   '图像分割/FCN/logs/Epoch100-Train_Loss0.5110-Val_Loss0.5056.pth',
    ...
    def generate(self):  
        self.net = AttU_Net(num_classes=2)
        # 加载训练好的模型
    ...
    def detect_image(self, image):
        ...
        #print(pr.shape)
        cv2.imwrite("图像分割/FCN/提交结果/AttU-Net_2996.png",np.uint8(pr),[cv2.IMWRITE_PNG_COMPRESSION, 0])
