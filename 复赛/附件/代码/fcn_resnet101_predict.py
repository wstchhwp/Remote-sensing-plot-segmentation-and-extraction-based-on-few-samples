...
class SEResNet101(object):
    #--------------------------------------------------------------#
    #   注意修改model_path、num_classes和backbone,使其符合自己的模型
    #--------------------------------------------------------------#
    _defaults = {
        "model_path"        :   '图像分割/FCN/logs_fcn_resnet101/Epoch100-Train_Loss0.5081-Val_Loss0.4951.pth',
    ...
    def detect_image(self, image):
        ...
        #print(pr.shape)
        cv2.imwrite("图像分割/FCN/提交结果/SENet+ResNet101+FCN_2996.png",np.uint8(pr),[cv2.IMWRITE_PNG_COMPRESSION, 0])
