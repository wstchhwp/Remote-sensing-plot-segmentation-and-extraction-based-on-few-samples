...
class UNet(object):
    ...
    #--------------------------------------------------------------#
    _defaults = {
        "model_path"        :   '图像分割/FCN/logs_unet/Epoch52-Train_Loss0.5601-Val_Loss0.5519-Train_Dice0.4534-Val_Dice0.4426.pth',
    ...
    def detect_image(self, image):
        ...
        #print(pr.shape)
        cv2.imwrite("图像分割/FCN/提交结果/U-Net_2996.png",np.uint8(pr),[cv2.IMWRITE_PNG_COMPRESSION, 0])
